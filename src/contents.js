module.exports = {
  ...
  introduce: `
    대학에서 안드로이드 모바일을 전공하고<br /> 실무에서 B2B 솔루션 프로그램 개발 및 운영(안드로이드 모바일 / 데이터베이스 / 대규모 실시간 인터페이스 서버 구축 / VAN•PG사 결제 서비스 인터페이스 개발 등)을 담당했습니다.<br /> 그리고 커뮤니케이션을 통해 좋은 협업으로 빠르게 문제 해결을 해왔습니다.
    `  ,
  contents: {
    'Skill Set': [
      {
